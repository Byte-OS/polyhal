use crate::currrent_arch::{CPU_ID, MBOOT_PTR};
use crate::debug::{display_info, println};
use crate::pagetable::PageTable;
use crate::percpu::set_local_thread_pointer;
use crate::{hart_id, shutdown, BOOT_STACK, CPU_NUM, STACK_SIZE};
